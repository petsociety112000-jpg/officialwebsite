...
export const PRODUCTS = [
  {
    ...
    price: 2499,
    originalPrice: 2999,
    description: 'Complete, balanced nutrition for adult large-breed dogs with essential nutrients for healthy joints, muscles, and digestion.',
    rating: 4.8,
    reviews: 312,
    badge: 'Best Seller',
    badgeType: 'teal',
  ...
  },
  {
    ...
    price: 649,
    originalPrice: 799,
    description: 'A gentle starter recipe made for growing puppies, supporting strong bones, healthy development, and everyday energy.',
    rating: 4.6,
    reviews: 198,
    badge: 'New',
    badgeType: 'fuchsia',
  ...
  },
  {
    ...
    price: 799,
    originalPrice: 999,
    description: 'Tasty ocean-fish nutrition for adult cats, made to support a healthy coat, strong muscles, and daily vitality.',
    rating: 4.7,
    reviews: 256,
    badge: 'Popular',
    badgeType: 'teal',
  ...
  },
  {
    ...
    price: 549,
    originalPrice: 699,
    description: 'A nourishing Persian-cat formula with balanced nutrition to support a healthy coat and comfortable digestion.',
    rating: 4.5,
    reviews: 143,
    badge: null,
    badgeType: null,
  ...
  },
  {
    ...
    price: 349,
    originalPrice: 449,
    description: 'Tender chicken treats for rewarding good behaviour, training sessions, or sharing a little extra love.',
    rating: 4.9,
    reviews: 421,
    badge: 'Top Rated',
    badgeType: 'gold',
  ...
  },
  {
    ...
    price: 299,
    originalPrice: 399,
    description: 'A gentle anti-tick shampoo with plant-based care to help keep your pet clean, fresh, and comfortable.',
    rating: 4.7,
    reviews: 187,
    badge: 'Natural',
    badgeType: 'teal',
  ...
  },
  {
    ...
    price: 279,
    originalPrice: 349,
    description: 'Delicious bite-sized beef jerky treats made for happy training moments and between-meal rewards.',
    rating: 4.6,
    reviews: 134,
    badge: null,
    badgeType: null,
  ...
  },
  {
    ...
    price: 899,
    originalPrice: 1199,
    description: 'A comfortable cooling mat and harness combination designed for relaxed walks and cool rest on warm days.',
    rating: 4.4,
    reviews: 89,
    badge: 'Sale',
    badgeType: 'fuchsia',
